...
USE [BootCamp2020]
GO
/****** Object:  Table [dbo].[Employees]    Script Date: 11-04-2020 17:23:09 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[LoginDetails]    Script Date: 11-04-2020 17:23:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TBL_Employees]    Script Date: 11-04-2020 17:23:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[LoginDetails] ([user_id], [Username], [Password], [Role]) VALUES (1, N'Neha', N'neha123', N'admin')
GO
INSERT [dbo].[LoginDetails] ([user_id], [Username], [Password], [Role]) VALUES (2, N'Dipti', N'dipti123', N'user')
GO
SET IDENTITY_INSERT [dbo].[LoginDetails] OFF
GO
SET IDENTITY_INSERT [dbo].[TBL_Employees] ON 
GO
INSERT [dbo].[TBL_Employees] ([emp_id], [emp_name], [emp_dob], [emp_salary], [manager_id], [IsTrainer]) VALUES (100, N'Neha', CAST(N'1995-08-07T00:00:00.0000000' AS DateTime2), 151000.0000, 111, 0)
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_deleteRecord]    Script Date: 11-04-2020 17:23:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_employeeDetails]    Script Date: 11-04-2020 17:23:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_InsertEmp]    Script Date: 11-04-2020 17:23:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_Manager]    Script Date: 11-04-2020 17:23:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
